...
class Settings:
    ...
    max_search_candidates: int = int(os.getenv("MAX_SEARCH_CANDIDATES", "120"))
    max_rerank_candidates: int = int(os.getenv("MAX_RERANK_CANDIDATES", "100"))
    bm25_memory_threshold: int = int(os.getenv("BM25_MEMORY_THRESHOLD", "20000"))
