...
class VectorIndex:
    ...
    def ensure_loaded(self) -> None:
        ...
        if self.index_path.exists() and self.meta_path.exists():
            try:
                ...
                if meta.get("generation") == generation and meta.get("model") == self.model_name:
    ...
    def rebuild(self) -> None:
        ...
        self.meta_path.write_text(
            json.dumps(
                {"generation": generation, "model": self.model_name, "dimension": dimension, "chunk_ids": chunk_ids},
                ensure_ascii=False,
            ),
            encoding="utf-8",
        )
