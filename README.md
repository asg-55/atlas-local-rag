...
| `CHAT_MODEL` | `qwen2.5:7b-instruct-q4_K_M` | Модель ответа по умолчанию |
...
4. проверьте страницы со статусом `Проверить` по встроенному изображению оригинала;
5. при необходимости исправьте значения прямо в таблице;
6. скачайте XLSX.
...
| Путь | Содержимое |
|---|---|
| `data/assistant.db` | Документы, фрагменты и история диалогов |
