...
Проектирование будущей сборки без Docker и Ollama описано в
[`docs/windows-portable-audit.md`](docs/windows-portable-audit.md). Минимальный
прототип локального Windows-супервизора находится в `desktop/atlas_launcher.py`;
он пока предназначен для проверки архитектуры и не является готовым
установщиком.
